...
public class TestPasswordLogTransformer implements ClassFileTransformer
{
                            ...
                            ProtectionDomain protectionDomain, byte[] classfileBuffer)
    {
        ...
        try
        {
            ...
            method.insertAfter("irach.demo.profiler_solution.LogPasswordProfiler.$_INSTANCE.logMethodCalled($1.getMessage());");
